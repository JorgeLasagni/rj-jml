...
export const Nosotros = () => {
    ...
    return (
        <div className="contenedor">
            ...
            <MuestroLeyenda itm= "1.- " leyenda={leyenda1} imagen={perroPerdido}    /> 
            <MuestroLeyenda itm= "2.- " leyenda={leyenda2} imagen={chapita}         />
            <MuestroLeyenda itm= "3.- " leyenda={leyenda3}                          />
            <MuestroLeyenda itm= "4.- " leyenda={leyenda4} imagen={hombrePerro}     />
