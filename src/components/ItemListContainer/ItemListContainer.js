...
import { MuestroItem }      from "./MuestroItem"
...
export const ItemListContainer = () => {
    ...
    return (
        <div className="contenedor">
            ...
            <MuestroItem leyenda={leyenda1} imagen={perroPerdido}   />
            <MuestroItem leyenda={leyenda2} imagen={chapita}        />
            <MuestroItem leyenda={leyenda3}                         />
            <MuestroItem leyenda={leyenda4} imagen={hombrePerro}    />
